    ...
    <Animated.View entering={fadeInDown}>
        ...
        >
            <Image
                ...
                source={`http://192.168.1.29:5000/photos/profile-photo${item?._id ? item?._id : item}.png`}
                                ...
                                <View className="h-full">
                                    <View className="flex flex-row justify-center items-center mt-10">
                                        <Image
                                            ...
                                            source={`http://192.168.1.29:5000/photos/profile-photo${activeWorkerDetails?._id}.png`}
                                            placeholder={{ blurhash }}
                                            contentFit="cover"
                                            transition={1000}
                                        />
