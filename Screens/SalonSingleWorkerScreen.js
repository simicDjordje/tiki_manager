        ...
        <View className="h-full flex flex-col justify-between px-4">
          <View className="flex-1 flex flex-col justify-start items-center">
            <View className="w-full flex flex-row justify-between items-center mt-6">
                <View>
                  <Text className="text-2xl" bold>Jovanka Jovanovic</Text>
                </View>
            </View>
              ...
              {workers.length > 0 && 
                <ScrollView className="w-full -mt-16">
                    <View className="min-h-screen">
                        <TouchableOpacity onPress={handleToServices} className="bg-bgPrimary w-full mt-4 rounded-xl p-4 flex flex-col justify-between">
...
export default SalonSingleWorkerScreen