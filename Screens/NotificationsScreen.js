            ...
            <TouchableOpacity 
                ...
                {item?.reservationId && item?.reservationId?.sender && item?.reservationId?.sender?.hasProfilePhoto &&
                    <Image
                        ...
                        source={`http://192.168.1.14:5000/photos/profile-photo${item?.reservationId?.sender?._id}.png`}
        ...
        <Animated.View entering={FadeInDown} className="w-full mt-10 p-4 rounded-3xl border-textSecondary" style={{borderWidth: 0.5}}>
            <View className="w-full flex flex-row justify-between items-center">
                <Image
                    ...
                    source={`http://192.168.1.14:5000/photos/salon-logo_${requestDetails?.salonId?.logoId}.png`}
                    placeholder={{ blurhash }}
                    contentFit="cover"
                    transition={1000}
                />
        ...
        <Animated.View entering={FadeInDown} className="w-full mt-10 p-4 rounded-3xl border-textSecondary" style={{borderWidth: 0.5}}>
            ...
            <View className="w-full flex flex-row justify-center items-center">
                ...
                <Image
                    ...
                    // style={{borderWidth: 0.5}}
                    source={`http://192.168.1.14:5000/photos/profile-photo${requestDetails?.recipient}.png`}
                    placeholder={{ blurhash }}
                    contentFit="cover"
                    transition={1000}
                />
